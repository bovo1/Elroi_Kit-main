...
# message box mode
MESSAGE_BOX_INFORMATION = "information"
MESSAGE_BOX_WARNING = "warning"
MESSAGE_BOX_CONFIRMATION = "confirmation"
...
PEN_MODE_OPACITY = 16
PEN_MODE_IMAGE = 17
PEN_MODE_ADVANCED_LABELING = 18
PEN_MODE_SEMI_AUTO_LABELING = 19
PEN_MODE_PIXEL_BASED_LABELING = 20
...
PEN_SUB_MODE_SEMI_AUTO_LABELING = 5
PEN_SUB_MODE_RECTANGLE = 6
...
DRAWING_MODE_SEMI_AUTO_LABELING = 11
DRAWING_MODE_PIXEL_BASED_LABELING = 12
DRAWING_MODE_ADVANCED_LABELING = 13

# drawing sub mode
DRAWING_SUB_MODE_RECTANGLE_DEFAULT = "fill_selected_area"
DRAWING_SUB_MODE_RECTANGLE_SAL = "SAL"
...
RGB_LINE_DEFAULT_WIDTH = 2
RGB_LINE_SELECTED_WIDTH = 4
...
# Pixel Based Labeling Mode
PIXEL_BASED_LABELING_DEFAULT_WIDTH = 2
PIXEL_BASED_LABELING_SELECTED_WIDTH = 4
PIXEL_BASED_LABELING_OPACITY = 0.3

# label correction mode
LABEL_CORRECTION_WINDOW_WIDTH = 840
LABEL_CORRECTION_WINDOW_HEIGHT = 640
...
NORMAL_LABELS = [1, 2]
IMAGE_LABEL_COLOR = [255, 0, 0]

RESULT_BACKGROUD_COLOR = (83, 83, 83)

HISTOGRAM_BAR_BRUSH_COLOR = (120, 170, 255, 160)  
HISTOGRAM_BAR_PEN_COLOR = (200, 200, 200, 80)  
HISTOGRAM_BAR_THR_COLOR = (255, 255, 0, 200)
PIXEL_BASED_LABELING_BRUSH_COLOR = (0, 255, 0, 60)
PIXEL_BASED_LABELING_PEN_COLOR = (0, 255, 0, 200)

DISTRIBUTION_BEFORE_PEN_COLOR = (70, 130, 180, 0)  
DISTRIBUTION_AFTER_PEN_COLOR = (205, 92, 92, 0)  
DISTRIBUTION_BEFORE_BRUSH_COLOR = (70, 130, 180, 60)  
DISTRIBUTION_AFTER_BRUSH_COLOR = (205, 92, 92, 60)  
DISTRIBUTION_BEFORE_MEDIAN_COLOR = (70, 130, 180, 255)
DISTRIBUTION_AFTER_MEDIAN_COLOR = (205, 92, 92, 255)

# viewer mode
VIEWER_ORIGINAL_WIDTH = 1200
# visualization mode
...
VISUALIZATION_MODE_RGB = 0
VISUALIZATION_MODE_CMF = 1
VISUALIZATION_MODE_DLCMF = 2

SUBRGB_RED = 0
SUBRGB_GREEN = 1
SUBRGB_BLUE = 2
RGB =  [SUBRGB_RED, SUBRGB_GREEN, SUBRGB_BLUE]
...
pen_mode_to_draw_dict = {
    ...
    PEN_MODE_SEMI_AUTO_LABELING: DRAWING_MODE_SEMI_AUTO_LABELING,
    PEN_MODE_PIXEL_BASED_LABELING: DRAWING_MODE_PIXEL_BASED_LABELING,
    PEN_MODE_ADVANCED_LABELING: DRAWING_MODE_ADVANCED_LABELING
}
...
pen_obj_key_to_mode_dict = {
    ...
    'penSemiAutoLabeling': PEN_MODE_SEMI_AUTO_LABELING,
    'penPixelBasedLabeling': PEN_MODE_PIXEL_BASED_LABELING,
    'penAdvancedLabeling': PEN_MODE_ADVANCED_LABELING
}
...
FONT_NANUM_SQUARE_NEO = "NanumSquareNeo"
...
# Graph Export
GRAPH_EXPORT_SIZE_RANGE = (1, 10000)  # (min, max)

GRAPH_EXPORT_DEFAULT_DPI = 100
GRAPH_EXPORT_DPI_RANGE = (100, 1000)  # (min, max)

GRAPH_EXPORT_DEFAULT_GRID_OPACITY = 70
GRAPH_EXPORT_GRID_OPACITY_RANGE = (0, 100)  # (min, max)

GRAPH_EXPORT_DEFAULT_CSV_PRECISION = 10
GRAPH_EXPORT_CSV_PRECISION_RANGE = (1, 50)  # (min, max)

GRAPH_EXPORT_DEFAULT_BACKGROUND_COLOR = "rgba(64, 64, 64, 255)"
GRAPH_EXPORT_DEFAULT_AXIS_COLOR = "rgba(0, 0, 0, 255)"

GRAPH_EXPORT_SETTINGS = {
    "sizeRange": GRAPH_EXPORT_SIZE_RANGE,
    "defaultDpi": GRAPH_EXPORT_DEFAULT_DPI,
    "dpiRange": GRAPH_EXPORT_DPI_RANGE,
    "defaultGridOpacity": GRAPH_EXPORT_DEFAULT_GRID_OPACITY,
    "gridOpacityRange": GRAPH_EXPORT_GRID_OPACITY_RANGE,
    "defaultBackgroundColor": GRAPH_EXPORT_DEFAULT_BACKGROUND_COLOR,
    "defaultAxisColor": GRAPH_EXPORT_DEFAULT_AXIS_COLOR,
    "defaultCsvPrecision": GRAPH_EXPORT_DEFAULT_CSV_PRECISION,
    "csvPrecisionRange": GRAPH_EXPORT_CSV_PRECISION_RANGE,
}
